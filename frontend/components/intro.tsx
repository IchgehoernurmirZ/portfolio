...
export default function Intro() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/profilepic.png"
              alt="Ziyi Zhang profile picture"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        <span className="font-bold">Hi, I'm Ziyi.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> currently{" "}
        <span>pursuing a </span>
        <span className="font-bold">Master's in Information Systems </span>
        <span>
          and actively seeking{" "}
          <span className="font-bold">internship and job opportunities. </span>
        </span>
        I love building <span className="italic">sites & apps</span>.
      </motion.h1>
      <motion.div
      ...
      >
        ...
        <a
          ...
          target="_blank"
          href="https://www.linkedin.com/in/ziyi-zhang-068165229"
        >
          <BsLinkedin />
        </a>

        <a
          className="bg-white p-4 text-gray-700 text-[1.35rem] flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60"
          target="_blank"
          href="https://github.com/IchgehoernurmirZ"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
